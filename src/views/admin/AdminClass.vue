  ...
  <div class="class-wrap">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-fa el-icon-fa fa-group"></i> 实验室管理
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="container">
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          <el-table-column label="实验室Id" prop="id" />
          <el-table-column label="实验室名" prop="name" />
          <el-table-column label="所属系" prop="departmentName" />
          <el-table-column label="所属专业" prop="majorName" />
          <el-table-column label="机器数量" prop="grade" />
          <el-table-column label="实验室描述" prop="majorName" />
